      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-sub">
            Queue the articles you find. We compile them into a beautiful ebook and deliver it straight to your <strong style={{fontWeight: 600, color: 'var(--text)'}}>Kindle</strong>.
          </p>
