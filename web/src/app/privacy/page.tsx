        ...
        >
          ...
          <Section title="Information We Collect">
            ...
            <ul className="list-disc pl-6 mt-3 space-y-2">
              ...
              <li>
                <strong style={{ color: "var(--color-text)" }}>Send history</strong> —
                a log of when deliveries were made, including article count
                and delivery status, so you can review past sends.
              </li>
              <li>
                <strong style={{ color: "var(--color-text)" }}>Delivery preferences</strong> —
          ...
          <Section title="How We Use Your Information">
            ...
            <ul className="list-disc pl-6 mt-3 space-y-2">
              ...
              <li>
                <strong style={{ color: "var(--color-text)" }}>Article extraction</strong> —
                we fetch article URLs you provide to extract readable content
                for your ebook.
              </li>
              <li>
                <strong style={{ color: "var(--color-text)" }}>EPUB generation</strong> —
                extracted articles are bundled into an EPUB ebook formatted for
                Kindle reading.
              </li>
              <li>
                <strong style={{ color: "var(--color-text)" }}>Email delivery</strong> —
          ...
          <Section title="Email Practices">
            ...
            <ul className="list-disc pl-6 mt-3 space-y-2">
              ...
              <li>
                ...
                <span style={{ color: "var(--color-text)" }}>kindle@q2kindle.com</span>)
          ...
          <Section title="Third-Party Services">
            ...
            <ul className="list-disc pl-6 mt-3 space-y-2">
              ...
              <li>
                <strong style={{ color: "var(--color-text)" }}>Brevo</strong> —
                email delivery service for sending EPUBs to your Kindle.
              </li>
              <li>
                <strong style={{ color: "var(--color-text)" }}>Resend</strong> —
                delivers authentication emails (magic link sign-in).
              </li>
              <li>
                <strong style={{ color: "var(--color-text)" }}>Netlify</strong> —
          ...
          <Section title="Security">
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong style={{ color: "var(--color-text)" }}>HTTPS everywhere</strong>{" "}
